...
- **Frontend:** [`ui/ui-development-guide.md`](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md)
...
| **[`ui/ui-development-guide.md`](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md)** | A **beginner, step-by-step guide to building the website (frontend)**, including every git command and a local test for each CR (U0–U9). Its [Frontend architecture reference](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#appendix--frontend-architecture-reference) holds the frontend design detail (moved from this file's old §7.2). | You're sitting down to write frontend code. |
...
| **Frontend** module structure, API client, slices/thunks, routing, data-driven map, UX states | [UI guide → Frontend architecture reference](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#appendix--frontend-architecture-reference) | plan.md §7.2 |
...
| **Frontend cross-cutting** (config, token storage, client-side logging) | [UI guide → Frontend architecture reference §C](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#c-cross-cutting-frontend-side) | plan.md §7.3 |
...
The endpoint-by-endpoint realization of this contract is the [backend API Reference](https://github.com/LTRide2/LTR-Backend/tree/main/plan/backend/backend-development-guide.md#appendix-a--backend-api-reference-v1); the client-side realization is the [frontend reference](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#appendix--frontend-architecture-reference).
...
| CR | Title | Branch | Parent | Also needs | Step-by-step | PR | Status |
|---|---|---|---|---|---|---|---|
| U0 | Project hygiene (router dep, API client, `.env`) | `cr/u0-hygiene` | `main` | — | [U0](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u0--project-hygiene-foundation-no-visible-change) | — | 🧪 |
| U1 | Real login + session restore + logout | `cr/u1-real-auth` | U0 | **B3** | [U1](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u1--real-login-replaces-the-fake-login) | — | 🧪 |
| U2 | Routing + role-guarded `ProtectedRoute` | `cr/u2-routing` | U1 | — | [U2](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u2--routing-real-pages-with-urls) | — | 🧪 |
| U3 | Data-driven lots & spaces from API | `cr/u3-real-lots` | U2 | **B4** | [U3](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u3--show-real-lots-and-spaces-data-driven-map) | — | 🧪 |
| U4 | Persist enable/disable (optimistic + rollback) | `cr/u4-save-status` | U3 | **B5** | [U4](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u4--make-enabledisable-actually-save) | — | 🧪 |
| U5 | Student dashboard + register interest | `cr/u5-student-interest` | U4 | **B6** | [U5](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u5--student-registers-interest-core-feature-1) | — | 🧪 |
| U6 | Admin interest panel + Manual Assign | `cr/u6-admin-assign` | U5 | **B7** | [U6](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u6--admin-assigns-spaces-core-feature-2) | — | 🧪 |
| U7 | Update school map image (multipart upload) | `cr/u7-map-upload` | U6 | map endpoint | [U7](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u7--update-the-school-map-image) | — | 🧪 |
| U8 | Place & arrange spots (drag-and-drop layout editor) | `cr/u8-arrange-spots` | U7 | **B8** | [U8](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u8--place--arrange-parking-spots-drag-and-drop-layout-editor) | — | 🧪 |
| U9 | Add a new parking lot from the admin UI | `cr/u9-add-lot` | U8 | **B9** | [U9](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#cr-u9--add-a-new-parking-lot-from-the-admin-ui) | — | 🧪 |

**Extensions (`B13–B16`, `U10`) — PoC-validated, beyond the core plan; not yet expanded into guide sections.**

The PoC (§2) validated four features beyond core U0–U9. The **frontend is already prototyped** (see the UI `backport.md` and the U# lessons — including the [U10 Student Management extension lesson](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/lessons/README.md)); each still needs its **backend** CR. These stack after **B9/U9** and may be sequenced before or after the Phase-4 hardening pass. The per-endpoint contract each adds is digested in the backend `backport.md`; the runtime flows are in [§6.5](#65-extension-flows-surfaced-by-the-poc-roster-withdraw-move) and the entities/enums in [§5.1](#51-data-model-entities).
...
| U10 | Student Management (roster + CSV + direct assign/move) | B13, B14 | *(consumes B13/B14)* | [U10 lesson](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/lessons/U10-student-management.md) | 🧪 |
...
| **Frontend build & serve** (`npm run build` → `dist/`, nginx static serving, prod `VITE_*`, SPA fallback) | UI guide → [Deployment (frontend)](https://github.com/LTRide2/lt-parking-site-project/blob/main/plan/ui/ui-development-guide.md#part-f3--deployment-frontend) |
