...
>
> **Do the backend (and ideally the frontend) first** — you're deploying the app you built in the [Backend](https://github.com/LTRide2/LTR-Backend/blob/main/plan/backend/lessons/README.md) and [UI](../../ui/lessons/README.md) tracks.
