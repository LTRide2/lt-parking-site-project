...
4. **Steps (unassign):** with the same admin, click the now-blue space → the Unassign/Move sub-panel appears (selecting it did **not** unassign it) → click **Unassign**.
